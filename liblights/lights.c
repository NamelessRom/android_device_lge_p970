...
#define ID(w0, w1, w2, w3, b0, b1, v) \
    {(w0) ^ v, (w1) ^ v, (w2) ^ v, (w3) ^ v, b0, b1}

#define IDINV(w0, w1, w2, w3, b0, b1) \
    ID(w0, w1, w2, w3, b0, b1, 0), ID(w0, w1, w2, w3, b0, b1, INV)

#define BOTH(w0, w1, w2, w3, b01) \
    ID(w0, w1, w2, w3, b01, b01, 0), ID(w3, w2, w1, w0, b01, b01, 0)

#define ALL(w0, w1, w2, w3, b01) \
    IDINV(w0, w1, w2, w3, b01, b01), IDINV(w3, w2, w1, w0, b01, b01)

#define INOUT(w03, w12, b01) \
	ID(w03, w12, w12, w03, b01, b01, 0), ID(w12, w03, w03, w12, b01, b01, 0)

#define SPECIAL_WAVES 16

static enum WAVE special_waves[SPECIAL_WAVES][LEDS] = {
    BOTH(WAVE_143, WAVE_242, WAVE_341, WAVE_44, WAVE_8 | INV),
    ALL(WAVE_26 | INV, WAVE_224, WAVE_422, WAVE_62, WAVE_8 | INV),
    INOUT(WAVE_224, WAVE_422, WAVE_242),
    INOUT(WAVE_17 | INV, WAVE_71, WAVE_8),
    {WAVE_44, WAVE_44 | INV, WAVE_44 | INV, WAVE_44, WAVE_8 | INV, WAVE_8 | INV},
    {WAVE_224, WAVE_224, WAVE_224, WAVE_224, WAVE_62, WAVE_62},
    INOUT(WAVE_17 | INV, WAVE_26 | INV, WAVE_26 | INV),
    INOUT(WAVE_62, WAVE_71, WAVE_62),
};
        ...
        struct light_state_t const *state)
{
    ...
    write_int(LED_PATH "brightness", brightness / 2);

    return write_int(LCD_FILE, brightness);
}
        ...
        struct light_state_t const *state)
{
    ...
    if (p.special) {
        /*
         * Use the higher 4 bits of each of the 3 colors to determine
         * the brightness of the white and blue leds.
         * Use the lower 4 bits to determine the special mode.
         */
        int white = rgb_coeff_avg(state->color & 0xf0f000, 87, 169, 0) * 0xff / 0xf0;
